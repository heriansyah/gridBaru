...
% ------------------------------------------------------------
% Generate 100 test scenarios for Y-intersection turns.
% ------------------------------------------------------------
SCRIPT_DIR = fileparts(mfilename('fullpath'));
OUT_CSV = fullfile(SCRIPT_DIR, 'test_intersection_y3.csv');
...
for i = 1:size(cases, 1)
    approach = cases{i, 1};
    maneuver = cases{i, 2};
    scenario = sprintf('Test_y_%s_%s_%02d', approach, maneuver, i);
    [x, y] = generate_route_y(approach, maneuver, TIMES, STEM_LEN_M, BRANCH_LEN_M, TURN_RADIUS_HINT, false);
